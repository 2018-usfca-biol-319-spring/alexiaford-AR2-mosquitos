...
Using mosquito data collected and provided by NEON this report will use R and RStudio to visualize results and test how the distribution of elevation varies across the National Ecological Observatory Network (NEON) sites and differing species. To begin, the mosquito NEON data was read into RStudio. R and RStudio was used in conjunction with the ggplot2 and dplyr packages to analyze the data. ANOVA was used in RStudio for plots made to test for significance of the results found. The data, code, and other files needed to reproduce the analyses are available on GitHub. 

This report will specifically be analyzing how the distribution of elevation varies across all NEON sites and species using the species found at the "ONAQ" NEON site, the elevation of *Culex tarsalis* species at all sites, and the elevation of *Aedes nigromaculis* species at all sites. 
...
```{r map-of-culex-elevation-all-sites}
