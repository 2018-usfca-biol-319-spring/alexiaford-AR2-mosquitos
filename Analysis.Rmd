...
This report will specifically be analyzing how the distribution of elevation varies across all NEON sites and species using box plots and geographical data. The elevation of the "ONAQ" NEON site and the elevation of *Culex tarsalis* and *Aedes nigromaculis* species will be of great significance for this report. This report will ask: what are some ways in which the distribution of elevation varies across NEON sites and species? Hypothesizing that the distribution of elevation of mosquitoes at varying sites is dependent upon factors such as: feeding, vegetation, location, mating, etc. 
...
This report will specifically be analyzing how the distribution of elevation varies across all NEON sites and species using: the "ONAQ" NEON site, the elevation of *Culex tarsalis* species at all sites, and the elevation of *Aedes nigromaculis* species at all sites. The "ONAQ" NEON site was of significance for this report as it had a higher elevation than the majority of the other sites.
...
This number shows that there are similarities in the elevation of mosquitoes at all NEON sites because the number is so small there is a  very low percentage that what we are observing is random in this box plot. For this reason we can reject the null hypothesis.
...
**Chi-square test**
ANOVA p-value: 2.2e-16
This number shows that there are similarities in the elevation of mosquito species at the "ONAQ" NEON site because the number is so small there is a  very low percentage that what we are observing is random in this box plot. For this reason we can reject the null hypothesis.
...
**Chi-square test**
ANOVA p-value: 2.2e-16
This number shows that there are similarities in the elevation of *Culex tarsalis* species at all NEON sites because the number is so small there is a very low percentage that what we are observing is random in this box plot. For this reason we can reject the null hypothesis.
